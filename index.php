...
<html lang="en">
  <head>
    ...
    <?php 
          session_start ();
          if(!isset($_SESSION["/assets/login"]))
	        header("location:login.php"); 
    ?>

    <title> Sistem Informasi Akademik UNIKOM </title>
              ...
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i> Data Dosen <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.php?page=tampil_dos">Tampil Data</a></li>
                      <li><a href="index.php?page=tampil_dos">Tambah Data</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/profile.jpg" alt="">Ikhwanushofa Effendi
                  </a>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            Copyright @ 2021 Aplikasi Akademik : Ikhwanushofa Effendi
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
