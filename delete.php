...
if(isset($_GET['Nip'])){
	...
	if(mysqli_num_rows($cek) > 0){
		...
		if($del){
			echo '<script>alert("Berhasil menghapus data."); document.location="index.php?page=tampil_dos";</script>';
		}else{
			echo '<script>alert("Gagal menghapus data."); document.location="index.php?page=tampil_dos";</script>';
		}
	}else{
		echo '<script>alert("ID tidak ditemukan di database."); document.location="index.php?page=tampil_dos";</script>';
	}
}else{
	echo '<script>alert("ID tidak ditemukan di database."); document.location="index.php?page=tampil_dos	";</script>';
}
